class FormulaGeneral{
    ...
    operacion(){
        ...
        this.positivo = Math.pow(this.num_b,2) - (4 * this.num_a * this.num_c);
           this.positivo = Math.sqrt(this.positivo);
             this.positivo = ( - this.num_b) + (this.positivo);
               this.positivo = this.positivo / (2 * this.num_a);

        //operacion en negativo
        this.negativo = Math.pow(this.num_b,2) - (4 * this.num_a * this.num_c);
           this.negativo = Math.sqrt(this.negativo);
             this.negativo = ( - this.num_b) - (this.negativo);
               this.negativo = this.negativo / (2 * this.num_a);
